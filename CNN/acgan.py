...
from tensorflow.keras.layers import LeakyReLU, Embedding, multiply
...
class ACGAN():
    ...
    def build_generator(self):
        ...
        # 生成网络的输入是一个带标签的随机数，具体操作方式是生成一个N维的正态分布随机数，
        # 再利用Embedding层将正整数（索引值）转换为N维的稠密向量，并将这个稠密向量与N维的正态分布随机数相乘。
